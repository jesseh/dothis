...
tinyMCE.init({
    ...
    plugins: 'advlink,fullscreen,paste,searchreplace,grappelli',
    // directionality : "rtl",
    ...
    theme_advanced_buttons1: 'formatselect,|,bold,italic,underline,|,bullist,numlist,blockquote,|,justifyleft,justifycenter,justifyright,justifyfull,|,undo,redo,|,link,unlink,|,fullscreen,|,grappelli_adv',
    theme_advanced_buttons2: 'search,|,pasteword,|,code,|,cleanup,|,grappelli_documentstructure',
